...
public interface MemberMapper {
	...
	@Insert("INSERT INTO MEMBER (MEMBER_ID, ID, PASSWORD, NAME, EMAIL, PHONE, ADDRESS, ADDRESS_DETAIL, KAKAO_ID, CREATED_AT, UPDATED_AT) " +
			"VALUES (MEMBER_SEQ.NEXTVAL, #{id}, #{password}, #{name}, #{email}, #{phone}, #{address}, #{addressDetail}, #{kakaoId}, SYSDATE, SYSDATE)")
